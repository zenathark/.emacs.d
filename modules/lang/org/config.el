...
(defvar +org-dir (expand-file-name "~/projects/org")
  "project directory")

(push (concat zen-package-load-path "org/contrib/lisp") load-path)
...
(add-hook! org-mode
  #'(zen|disable-line-numbers  ; no line numbers
...
(defun +org-init-ui ()
  ...
  (setq-default
   ...
   ;; current theme.
   org-preview-latex-image-directory (concat zen-cache-dir "org-latex/")
